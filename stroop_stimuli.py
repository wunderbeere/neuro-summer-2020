...
# abbreviate parameter names if possible (e.g. rgb = thisBlock_6.rgb)
if thisBlock_6 != None:
    for paramName in thisBlock_6:
        exec('{} = thisBlock_6[paramName]'.format(paramName))
...
# abbreviate parameter names if possible (e.g. rgb = thisBlock_7.rgb)
if thisBlock_7 != None:
    for paramName in thisBlock_7:
        exec('{} = thisBlock_7[paramName]'.format(paramName))
...
# abbreviate parameter names if possible (e.g. rgb = thisBlock_8.rgb)
if thisBlock_8 != None:
    for paramName in thisBlock_8:
        exec('{} = thisBlock_8[paramName]'.format(paramName))
...
# abbreviate parameter names if possible (e.g. rgb = thisBlock_9.rgb)
if thisBlock_9 != None:
    for paramName in thisBlock_9:
        exec('{} = thisBlock_9[paramName]'.format(paramName))
